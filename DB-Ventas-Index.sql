...
CREATE INDEX idx_promotion_date ON promotion.promotion(date_promotion DESC);
...
-- Índices para la tabla sale.sale (búsqueda por fecha y detalles de venta)
CREATE INDEX idx_sale_date ON sale.sale(date_sale);
CREATE INDEX idx_sale_detail ON sale.sale(id_detail);
...
-- Índices para la tabla sale.sale_detail (optimización de cálculos de ventas)
CREATE INDEX idx_sale_detail_item ON sale.sale_detail (id_item);
CREATE INDEX idx_sale_detail_cost ON sale.sale_detail (cost_detail);
...
CREATE INDEX idx_buys_id_buys_detail ON buys.buys(id_buys_detail);
CREATE INDEX idx_buys_detail_id ON buys.buys_detail(id);

CREATE INDEX idx_buys_id_buys_supplier ON buys.buys(id_buys_supplier);
CREATE INDEX idx_buys_supplier_id ON buys.buys_supplier(id);
...
CREATE INDEX idx_sale_id_detail ON sale.sale(id_detail);
